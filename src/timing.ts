 ...
 */
function calculateCycles(instruction: Instruction, context?: TimingContext): number {
 ...
 */
function isFastROM(address: number, cartridgeSpeed: MemorySpeed): boolean {
 ...
 */
function getMemoryTiming(address: number, cartridgeSpeed: MemorySpeed): MemorySpeed {
